/*
  ...
  - You are about to drop the column `lastCheckedItem` on the `Item` table. All the data in the column will be lost.
  - You are about to drop the column `lastCheckedItem` on the `List` table. All the data in the column will be lost.
